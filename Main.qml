...
Window {
    ...
    Rectangle{
        ...
        readonly property color fg20: Qt.rgba(style.foregroundColor.r, style.foregroundColor.g, style.foregroundColor.b, 0.2)
        readonly property color fg30: Qt.rgba(style.foregroundColor.r, style.foregroundColor.g, style.foregroundColor.b, 0.3)
        readonly property color fg50: Qt.rgba(style.foregroundColor.r, style.foregroundColor.g, style.foregroundColor.b, 0.5)
        readonly property color fg75: Qt.rgba(style.foregroundColor.r, style.foregroundColor.g, style.foregroundColor.b, 0.75)
        readonly property color bg20: Qt.rgba(style.backgroundColor.r, style.backgroundColor.g, style.backgroundColor.b, 0.2)
        readonly property color bg75: Qt.rgba(style.backgroundColor.r, style.backgroundColor.g, style.backgroundColor.b, 0.75)
        ...
        color: "#DEE3E6"
        width: 950 // / style.monitorRatio
        height: 68 / style.monitorRatio
    ...
    Rectangle{
        ...
        Rectangle {
                    id: dropShadowRect
                    property real offset: Math.min(parent.width*0.03, parent.height*0.03)
                    color: "black"
                    width: parent.width
                    ...
                    RowLayout{
                        ...
                        Item {
                            ...
                            RowLayout{
                                ...
                                Repeater{
                                    id:colorRepeater
                                    model :  myProxyModel.getColorFilter() //["#EF2929","#FCAF3E","#FCE94F","#8AE234","#EF2929","#FCAF3E","#FCE94F","#8AE234","#729FCF","#AD7FA8","#E9B96E","#8AE234","#729FCF","#AD7FA8","#E9B96E"]
                                    delegate: Rectangle{
                                        ...
                                        MouseArea{
                                            ...
                                            onClicked: {
                                                myProxyModel.addTag("color", modelData)
                                                //tagModel.append({ name: "color", signLogical: " : " , value1: modelData, isTo:'', value2:'', filter:"colorFilter" })
                                                tagModel.append({name: "color",color:modelData,value1:"",value2:"",value3:"",value4:"",compVal:"", filter:"colorFilter"})
                        ...
                        Rectangle{
                            ...
                            RowLayout {
                                ...
                                ComboBox{
                                    ...
                                    model: myProxyModel.getDataComboBox()//["SEX" , "FUCK" , "PUSSY" , "VIRGINAwwwwwwwwww" , "CUNT" , "ASS" , "MOMO" , "VOLVO"]
                                    ...
                                    Text {
                                        id:maximumText
                                        text: "Longest String: " + control.findLongestString(control.model)
                                        anchors.centerIn: parent
                                        Component.onCompleted: {control.txtWidth = maximumText.width}
                                        visible : false
                                    }
                                    ...
                                    contentItem: TextField {
                                        ...
                                        onTextChanged: {
                                            if(txtContentItem1.text !== ""){
                                                //console.log(text)
                                                control.model = myProxyModel.filterCombo(text, "String");
                                    ...
                                    popup: Popup {
                                        ...
                                        MouseArea{
                                            anchors.fill: parent
                                            onClicked: {
                                                txtContentItem1.text = control.textAt(control.highlightedIndex)
                                                popupCombo1.close()
                                            }
                                        }
                                    }
                                ...
                                TextField{
                                    ...
                                    onAccepted:{
                                        tagModel.append({name: control.currentText, color:"", value1: descriptionField.text,value2:"",value3:"",value4:"",compVal:"", filter:"filter1"})
                                        //console.log(control.currentText, descriptionField.text)
                                        myProxyModel.addTag1(control.currentText, descriptionField.text);
                                    }
                                }
                            }
                        }
                        ...
                        Rectangle{
                            ...
                            RowLayout {
                                ...
                                ComboBox{
                                    ...
                                    //Layout.minimumWidth: 50
                                    //Layout.maximumWidth: 50
                                    model: myProxyModel.getDataComboBoxInt()//["SEX" , "FUCK" , "PUSSY" , "VIRGINAwwwwwwwwww" , "CUNT" , "ASS" , "MOMO" , "VOLVO"]
                                    ...
                                    Text {
                                        ...
                                        text: "Longest String: " + control.findLongestString(control.model)
                                        anchors.centerIn: parent
                                        Component.onCompleted: {control2.txtWidth = maximumText1.width}
                                        visible : false
                                    }
                                    delegate: ItemDelegate {
                                    ...
                                    contentItem: TextField {
                                        ...
                                        onTextChanged: {
                                            if(txtContentItem.text !== ""){
                                                //console.log(text)
                                                control2.model = myProxyModel.filterCombo(text, "Int");
                                    ...
                                    popup: Popup {
                                        ...
                                        MouseArea{
                                            anchors.fill: parent
                                            onClicked: {
                                                txtContentItem.text = control2.textAt(control2.highlightedIndex)
                                                popupCombo2.close()
                                            }
                                        }
                                    }
                                ...
                                TextField{
                                    ...
                                    onAccepted:{
                                        if (txtFromFilter1.text !== "" && txtToFilter1.text !== "ERROR" && txtToFilter1.text !== "" && style.isNumeric(txtFromFilter1.text)){

                                            tagModel.append({name: control2.currentText, color:"", value1:"", value2: txtFromFilter1.text, value3 : txtToFilter1.text, value4:"", compVal:"", filter:"filter2"})
                                            myProxyModel.addTag2(control2.currentText, txtFromFilter1.text, txtToFilter1.text)
                                        }
                                        else {
                                            redBackG1.color = "red"
                                            rbg1.running = true
                                ...
                                TextField{
                                    ...
                                    onAccepted: {
                                        ...
                                        if (txtToFilter1.text !== "" && txtToFilter1.text !== "ERROR" && txtFromFilter1.text !== "" && style.isNumeric(txtFromFilter1.text)){
                        ...
                        Rectangle{
                            ...
                            RowLayout {
                                ...
                                ComboBox{
                                    ...
                                    Text {
                                        id:maximumText3
                                        text: "Longest String: " + control3.findLongestString(control3.model)
                                        anchors.centerIn: parent
                                        Component.onCompleted: {control3.txtWidth = maximumText3.width}
                                        visible : false
                                    }
                                    delegate: ItemDelegate {
                                    ...
                                    contentItem: TextField {
                                        ...
                                        onTextChanged: {
                                            if(txtContentItem3.text !== ""){
                                                //console.log(text)
                                                control3.model = myProxyModel.filterCombo(text, "Int");
                                ...
                                TextField{
                                    ...
                                    onAccepted: {
                                        if (style.isNumeric(txtFilter3.text)){
                                            tagModel.append({name: control3.currentText, color:"", value1:"", value2:"", value3:"", value4: txtFilter3.text, compVal: lblComparision.text, filter:"filter3"})
                                            myProxyModel.addTag3(control3.currentText, txtFilter3.text, lblComparision.text)
                                        }
                                        else {
                                            redBackG3.color = "red"
                                            rbg3.running = true
                            ...
                            delegate:Rectangle{
                                    ...
                                    onClicked: {
                                        if(!typeHolder.selected){
                                            ...
                                            if(model.filter === "colorFilter"){
                                                myProxyModel.removeTag(model.filter, model.name, model.color)
                                            }
                                            else if(model.filter === "filter1"){
                                                myProxyModel.removeTag(model.filter, model.name, value1)
                                            }
                                            else if(model.filter === "filter2"){
                                                myProxyModel.removeTag(model.filter, model.name, model.value2)
                                            }
                                            else if(model.filter === "filter3"){
                                                myProxyModel.removeTag(model.filter, model.name, model.value4)
                                            }
                                        }
                                        else{
                                            ...
                                            if(filter === "colorFilter")
                                                myProxyModel.addTag(name, model.color)
                                            else if(filter === "filter1")
                                                myProxyModel.addTag1(name, value1)
                                            else if(filter === "filter2")
                                                myProxyModel.addTag2(name, value2, value3)
                                            else if(filter === "filter3")
                                                myProxyModel.addTag3(name, value4, compVal)
                                        }
                                    }
                                }
                                ...
                                RowLayout{
                                    ...
                                    Text {
                                        ...
                                        font.pixelSize: 17/1.3
                                        color:shortCut.colorHandler /*typeHolder.checked ? Style.foregroundColor : Style.hoverColor*/
                                        visible: model.value2 || model.value4 || model.color ? false :true
                                    }
                                    Text {
                                        id: itemValue2
                                        Layout.alignment: Qt.AlignLeft
                                        ...
                                        font.pixelSize: 17/1.3
                                        color:shortCut.colorHandler /*typeHolder.checked ? Style.foregroundColor : Style.hoverColor*/
                                        visible: model.value3 && model.value2 ? true :false
                                    }
                                    Label {
                                        text: "To"
                                        font.pixelSize:17 / 1.3
                                        ...
                                        MouseArea{
                                            ...
                                            onClicked: {
                                                ...
                                                if(model.filter === "colorFilter"){
                                                    ...
                                                    console.log(filter)
                                                    console.log(model.name, model.value1)
                                                    myProxyModel.removeTag(model.filter, model.name, value1)
                                                }
                                                else if(model.filter === "filter2"){
                                                    console.log(filter)
                                                    console.log(model.name, model.value2, model.value3)
                                                    myProxyModel.removeTag(model.filter, model.name, model.value2)
                                                }
                                                else if(model.filter === "filter3"){
                                                    console.log(filter)
                                                    console.log(model.name, model.value4)
                                                    myProxyModel.removeTag(model.filter, model.name, model.value4)
                                                }
                ...
                Repeater{
                    ...
                    MenuItem{
                        ...
                        contentItem: Rectangle{
                            ...
                            Image {
                                id: imgMenuTable
                                source: model.index === 0 ? "icons/goto-icon.jpg" : "icons/track-icon.jpg"
                                //anchors.centerIn: parent
                                width: 20
                                height: 20
                            }
